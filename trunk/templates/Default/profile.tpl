...
</a><a href="/" onClick="Profile.LoadPhoto(); $('.profileMenu').hide(); return false;"><img class="icon editphoto_ic" src="{theme}/images/spacer.gif" alt="" /><div>Изменить фотографию</div></a><a href="/" onClick="Profile.miniature(); return false;"><img class="icon editphoto_ic" src="{theme}/images/spacer.gif" alt="" /><div>Изменить миниатюру</div></a><a href="/" onClick="Profile.DelPhoto(); $('.profileMenu').hide(); return false;" id="del_pho_but" {display-ava}><img class="icon del_photo_ic" src="{theme}/images/spacer.gif" alt="" /><div>Удалить фотографию</div></a><br />[/owner]
...
[blacklist]<div class="leftcbor">
 ...
 [/happy-friends][/owner]
 [friends]<div class="albtitle">Друзья <span>{friends-num}</span><div><div class="mono_ico" onmouseover="myhtml.title('1', 'Показать всех друзей', 'newBBlockl')" id="newBBlockl1"></div></div></div>
 <div class="newmesnobg" style="padding:0px;padding-top:10px;">{friends}<div class="clear"></div>
 </div>[/friends]
 [online-friends]<div class="albtitle">Друзья на сайте <span>{online-friends-num}</span><div><div class="mono_ico_frOnline" onmouseover="myhtml.title('2', 'Показать всех друзей на сайте', 'newBBlockl')" id="newBBlockl2"></div></div></div>
...
<div class="profiewr">
 ...
 <div class="titleu">{name} {lastname} <div class="online_time">{online}</div>[owner]<a href="/editmypage" onClick="Page.Go(this.href); return false;" class="fl_r"><b>редактировать страницу</b></a>[/owner]</div>
 <div class="status">
